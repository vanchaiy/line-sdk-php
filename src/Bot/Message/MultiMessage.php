...
class MultiMessage
{
    public function __construct(string $channelAccessToken, array $userId)
    {
    ...
    public function curl(array $message)
    {
        ...
        return $this->request->post('https://api.line.me/v2/bot/message/multicast', json_encode($body));
    }
